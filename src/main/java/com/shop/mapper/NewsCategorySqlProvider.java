...
public class NewsCategorySqlProvider {

    public String insertSelective(NewsCategory record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("news_category");
    ...
    public String updateByPrimaryKeySelective(NewsCategory record) {
        SQL sql = new SQL();
