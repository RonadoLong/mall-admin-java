...
public interface VideoCategoryMapper {
    ...
    @Insert({
        "insert into video_category (id, title, ",
        "sort, create_time, ",
        "update_time, status)",
    ...
    @InsertProvider(type=VideoCategorySqlProvider.class, method="insertSelective")
    ...
    @UpdateProvider(type=VideoCategorySqlProvider.class, method="updateByPrimaryKeySelective")
